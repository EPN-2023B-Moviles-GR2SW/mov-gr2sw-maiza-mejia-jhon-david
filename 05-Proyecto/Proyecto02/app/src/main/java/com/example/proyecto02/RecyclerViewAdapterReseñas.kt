...
class RecyclerViewAdapterReseñas (
    private val contexto: Resenia,
    private val lista: ArrayList<Reseña>,
    private val recyclearView: RecyclerView
) : RecyclerView.Adapter <RecyclerViewAdapterReseñas.MyViewHolder>() {
